...
namespace Microsoft.AspNetCore.Server.Kestrel.Internal.Http
{
    public partial class Frame
    {
        ...
        private static readonly Type IConnectionDataFeatureType = typeof(global::Microsoft.AspNetCore.Http.Features.IConnectionDataFeature);
        ...
        private object _currentIConnectionDataFeature;
        ...
        private void FastReset()
        {
            ...
            _currentIConnectionDataFeature = this;
        ...
        private object FastFeatureGet(Type key)
        {
            ...
            if (key == IConnectionDataFeatureType)
            {
                return _currentIConnectionDataFeature;
            }
        ...
        private void FastFeatureSet(Type key, object feature)
        {
            ...
            if (key == IConnectionDataFeatureType)
            {
                _currentIConnectionDataFeature = feature;
                return;
            }
            if (key == IHttpAuthenticationFeatureType)
            {
        ...
        private IEnumerable<KeyValuePair<Type, object>> FastEnumerable()
        {
            ...
            if (_currentIConnectionDataFeature != null)
            {
                yield return new KeyValuePair<Type, object>(IConnectionDataFeatureType, _currentIConnectionDataFeature as global::Microsoft.AspNetCore.Http.Features.IConnectionDataFeature);
            }
