    ...
    public partial class FrameResponseHeaders
    {
        ...
        protected void CopyToFast(ref WritableBuffer output)
        {
                ...
                { 
                    ...
                    {
                        output.Write(_headers._rawContentLength);
                    }
                    else 
                        foreach (var value in _headers._ContentLength)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 133, 18));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._ContentType)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 151, 16));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._ContentEncoding)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 167, 20));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._ContentLanguage)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 187, 20));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._ContentLocation)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 207, 20));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._ContentMD5)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 227, 15));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._ContentRange)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 242, 17));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._Expires)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 259, 11));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._LastModified)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 270, 17));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._AcceptRanges)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 287, 17));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._Age)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 304, 7));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._ETag)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 311, 8));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._Location)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 319, 12));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._ProxyAutheticate)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 331, 21));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._RetryAfter)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 352, 15));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                    if (_headers._rawServer != null)
                    {
                        ...
                        foreach (var value in _headers._Server)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 367, 10));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._SetCookie)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 377, 14));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._Vary)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 391, 8));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._WWWAuthenticate)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 399, 20));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._AccessControlAllowCredentials)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 419, 36));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._AccessControlAllowHeaders)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 455, 32));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._AccessControlAllowMethods)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 487, 32));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._AccessControlAllowOrigin)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 519, 31));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._AccessControlExposeHeaders)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 550, 33));
                                output.WriteAsciiString(value);
                            }
                        }
                }
                ...
                { 
                        foreach (var value in _headers._AccessControlMaxAge)
                        {
                            if (value != null)
                            {
                                output.Write(new Span<byte>(_headerBytes, 583, 26));
                                output.WriteAsciiString(value);
                            }
                        }
                }
